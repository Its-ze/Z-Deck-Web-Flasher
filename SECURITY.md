...
| Version | Supported |
| ------- | --------- |
| Latest (`0.2.14-public`) | :white_check_mark: |
| Older releases | :x: |
...
- - The bundled non-secret firmware artifacts and `manifest.json`
  - - The Z-Deck source patch set under `source/patches/`
    ...
    - - Private Meshtastic channels, PSKs, or channel URLs
      - - Admin keys, private keys, or personal setup data
        - - Any credentials or secrets of any kind
          ...
          - 1. Open a [GitHub Security Advisory](https://github.com/Its-ze/Z-Deck-Web-Flasher/security/advisories/new) for this repository (private disclosure).
            2. 2. Describe the vulnerability, the affected component, and steps to reproduce.
               3. 3. Include your assessment of the impact and any suggested fix if you have one.
                  ...
                  6. ## Upstream Security Issues
                 
                  7. This firmware is derived from [Meshtastic firmware](https://github.com/meshtastic/firmware) (GPL v3). If the vulnerability is in the upstream Meshtastic codebase rather than the Z-Deck patches or flasher, please also report it to the [Meshtastic project](https://github.com/meshtastic/firmware/security).
