...
- The firmware base reports `2.8.0.zdeck6`; the public release label is `0.2.5-public`.
...
- USB SD mass storage is disabled in `0.2.5-public` because the CDC serial + MSC composite path was unstable on Windows during API sessions.
