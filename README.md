...
Public GitHub Pages flasher for **Z-Deck Firmware Pack 0.2.14 PUBLIC**.
...
- Release label: `Z-Deck 0.2.14-public`
- Firmware base version: `2.8.0.zdeck15`
- Target: `t-deck-tft`
...
- USB storage: disabled by default in `0.2.14-public` so Web Serial and Meshtastic API sessions stay stable; SD prep/journal/ringtone features still use the card internally.
