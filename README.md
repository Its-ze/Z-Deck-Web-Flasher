...
Public GitHub Pages flasher for **Z-Deck Firmware Pack 0.2.13 PUBLIC**.
...
- Release label: `Z-Deck 0.2.13-public`
- Firmware base version: `2.8.0.zdeck14`
- Target: `t-deck-tft`
...
- Build skin: Modern Field dark theme and compact on-device status layout with clipped front-page LoRa RX labels.
...
- USB storage: disabled by default in `0.2.13-public` so Web Serial and Meshtastic API sessions stay stable; SD prep/journal/ringtone features still use the card internally.
