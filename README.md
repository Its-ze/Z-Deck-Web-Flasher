...
Public GitHub Pages flasher for **Z-Deck Firmware Pack 0.2.28-cyberdeck**.
...
- Release label: `Z-Deck 0.2.28-cyberdeck`
- Firmware base version: `2.8.0.zdeck29`
- Target: `t-deck-tft`
...
- USB storage: disabled by default in `0.2.28-cyberdeck` so Web Serial and Meshtastic API sessions stay stable; SD prep/journal/ringtone/backup features still use the card internally.
