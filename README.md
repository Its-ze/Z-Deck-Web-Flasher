...
Public GitHub Pages flasher for **Z-Deck Firmware Pack 0.2.5 PUBLIC**.
...
- Release label: `Z-Deck 0.2.5-public`
- Firmware base version: `2.8.0.zdeck6`
- Target: `t-deck-tft`
...
- USB storage: disabled by default in `0.2.5-public` so Web Serial and Meshtastic API sessions stay stable; SD prep/journal/ringtone features still use the card internally.
