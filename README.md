...
Public GitHub Pages flasher for **Z-Deck Firmware Pack 0.2.6 PUBLIC**.
...
- Release label: `Z-Deck 0.2.6-public`
- Firmware base version: `2.8.0.zdeck7`
- Target: `t-deck-tft`
...
- USB storage: disabled by default in `0.2.6-public` so Web Serial and Meshtastic API sessions stay stable; SD prep/journal/ringtone features still use the card internally.
