...
Public GitHub Pages flasher for **Z-Deck Firmware Pack 0.2.26-cyberdeck**.
...
- Release label: `Z-Deck 0.2.26-cyberdeck`
- Firmware base version: `2.8.0.zdeck27`
- Target: `t-deck-tft`
...
- Home identity: the home header shows the configured Meshtastic owner name instead of a hard-coded CyberDeck title, and clips long names before they reach the top status area.
...
- USB storage: disabled by default in `0.2.26-cyberdeck` so Web Serial and Meshtastic API sessions stay stable; SD prep/journal/ringtone/backup features still use the card internally.
