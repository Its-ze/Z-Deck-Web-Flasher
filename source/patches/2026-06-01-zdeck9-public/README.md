# Z-Deck 0.2.8-public Source Patch Backup

Built artifact: `firmware/zdeck-2.8.0-zdeck9-public/`
Firmware identity: `2.8.0.zdeck9`
Pack label: `0.2.8-public`
Build folder: `20260601-zdeck9-t-deck-tft`

This archive preserves the public patch set used for the 0.2.8 public T-Deck build.
