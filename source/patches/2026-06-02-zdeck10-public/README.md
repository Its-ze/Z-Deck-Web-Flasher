# Z-Deck 0.2.9-public Source Patch Backup

Built artifact: `firmware/zdeck-2.8.0-zdeck10-public/`
Firmware identity: `2.8.0.zdeck10`
Pack label: `0.2.9-public`
Build folder: `20260601-221536-t-deck-tft`

This archive preserves the public patch set used for the 0.2.9 public T-Deck build.
