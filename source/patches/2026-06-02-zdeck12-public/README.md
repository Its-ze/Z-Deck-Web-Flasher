# Z-Deck 0.2.11-public Source Patch Backup

Built artifact: firmware/zdeck-2.8.0-zdeck12-public/
Firmware identity: 2.8.0.zdeck12
Pack label: 0.2.11-public
Build folder: 20260602-073938-t-deck-tft

This archive preserves the public patch set used for the 0.2.11 public T-Deck build.
