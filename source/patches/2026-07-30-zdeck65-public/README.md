# Z-Deck zdeck65 source patches

Reproducible source patches for firmware `2.8.0.zdeck65` / pack `0.2.64-cyberdeck`.

- `device-ui-blackberry-shell.patch` contains the Device UI launcher, startup handoff, and sketch-based six-button home screen.
