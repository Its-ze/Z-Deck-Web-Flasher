...
otaTestInstallButton?.addEventListener("click", () => armInstaller("Legacy 0.2.53 OTA test", "zdeck54 baseline for A/B OTA + dedicated MeshCore; use Standard for current zdeck66"));
